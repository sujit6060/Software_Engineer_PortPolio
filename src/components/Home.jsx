    ...
    <div className="container" style={{ marginTop: "100px" }}>
          ...
          <Row className="lead">
            ...
            <Col className="mt-5 lead fs-10" xs={12} md={8}>
              <p>
                ...
                <br />
                <br />
                I'm a Software Engineer who loves bringing together the technical and creative sides of building things. I use my tech know-how along with a keen eye for design to make products that not only work well but also look great. My main aim is to create apps that are not just powerful and efficient but also provide users with a delightful and seamless experience.
              </p>
              <p>
                <a
      ...
      <style jsx>{`
        ...
        @media (min-width: 768px) {
          /* Adjust styles for larger screens (e.g., laptop) */
          .lead {
            font-size: 18px;
          }
